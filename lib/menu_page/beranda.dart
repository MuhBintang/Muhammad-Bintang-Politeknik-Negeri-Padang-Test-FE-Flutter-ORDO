...
import 'package:testflutterordo/widgets/order_detail_widget.dart';
import 'package:testflutterordo/widgets/tracking_order_widget.dart';
import 'package:testflutterordo/widgets/tracking_popup.dart';
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  GestureDetector(
                    onTap: _showOrderTracking,
                    child: ProgressTracker(currentStep: 1),
                  ),
                  SizedBox(height: 16),
                  buildOrderDetail(),
                ],
